...
def product_detail(request, product_slug):
    ...
    products = {
        'capsicum': {'id': 1, 'title': 'Capsicum', 'selling_price': 15, 'product_image': 'images/product-1.jpg'},
        'tomato': {'id': 2, 'title': 'Tomato', 'selling_price': 30, 'product_image': 'images/product-5.jpg'},
